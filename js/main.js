...
function(t, e, i) {
    ...
    l.dialogueOpt.interval = a.
default.transTime(l.dialogueOpt.interval, 120),
    l.dialogueOpt.speed = a.
default.transTime(l.dialogueOpt.speed, 18),
    l.sunset = a.
default.transTime(l.sunset, 600),
    l.fireOpt.wordInterval = a.
default.transTime(l.fireOpt.wordInterval, 180),
    l.fireOpt.denseTime = a.
default.transTime(l.fireOpt.denseTime, 600),
    l.titleOpt.delay = a.
default.transTime(l.titleOpt.delay, 240),
    l.titleOpt.e = a.
default.transTime(l.titleOpt.e, 240),
    (0, s.
default)(l.width, l.height, l.canvases),
    e.
default = l
},
function(t, e, i) {
    ...
    function() {
        new(function() {
            ...
            },
            {
                ...
                default.dialogueOpt.speed, ++this.dialogue.current), t.fillText(this.dialogue.name + "：" + this.dialogue.txt.slice(0, this.dialogue.current), 20, 50), this.dialogue.current >= this.dialogue.txt.length && --this.dialogueOpt.interval <= 0) {
                        if (0 == l.
...
function(t, e, i) {
    ...
    y = function() {
        ...
        default.height:
            ...
            z = e.prtOption,
            P = void 0 === z ? {}: z;
            if (n(this, t), this.x = i || u.
        default.random(a.
        default.width / 8, 7 * a.
        default.width / 8), this.y = s, this.xEnd = o || this.x, this.yEnd = l || u.
        default.random(a.
        default.height / 8, 3 * a.
        default.height / 8), this.size = f, this.opacity = m, this.velocity = -Math.abs(g), this.wait = O || u.
        default.random(30, 60), this.radius = y, this.GRAVITY = p, this.hue = 360 * Math.random() | 0, this.color = k || "hsla(" + this.hue + ",80%,60%,1)", this.status = 1, _) {
                this.type = "words";
                var S = {
                    xStart: this.xEnd,
                    yStart: this.yEnd
        ...
        return s(t, [{
            key: "createParticles",
            value: function() {
                for (var t = 0; t < this.count; ++t) this.particles.push(new f.
            default({
                    x:
                    this.xEnd,
                    y: this.yEnd,
    ...
    s = function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                e = t.mini, i = void 0 === e ? 1 : e, r = t.gap, n = void 0 === r ? 5 : r, s = this.ctx.getImageData(0, this.y - this.size / 2, this.canvas.width, this.size).data, o = [], a = 0, l = this.y - this.size / 2, u = 0, h = 0, f = s.length; h <= f; h += 4 * n) s[h + 3] > 0 && ++u % i == 0 && o.push({
                    x: a,
                    y: l
                }),
